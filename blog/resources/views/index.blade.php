            ...
            <div class="row">
                ...
                <div  class="col-md-4 align-self-stretch">
                    <a href="{{route('id')}}" class="services">
                                            <img src="https://cocoon-pal.com/wp-content/uploads/2021/08/team-fund-crowdera.gif" width="100%" height="auto" alt="">
                ...
                <div class="col-md-4 align-self-stretch">
                    <a href="{{route('program')}}" class="services">
                                            <img src="https://cocoon-pal.com/wp-content/uploads/2021/08/three-build-2-1.svg" width="100%" height="auto" alt="">
                        <div class="inside-services">
                ...
                <div class="col-md-4 align-self-stretch">
                    <a href="{{route('tasweq')}}" class="services">
                                            <img src="https://cocoon-pal.com/wp-content/uploads/2021/08/three-build-1-3.svg" width="100%" height="auto" alt="">
                        <div class="inside-services">
