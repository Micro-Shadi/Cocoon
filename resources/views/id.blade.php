    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <p class="p-arrow"> الشعارات والهويات التجارية</p>
                <p class="text-justify">
                    هويتك التجارية هي العنصر الأهم في بناء رؤيتك وإظهارها كما يجب, لعملائك والفئة المستهدفة, فبناء هوية
                    قوية يساعد ترك انطباعٍ جيد لدى العملاء, واختيارك لشركة تبدع في فهم رؤيتك وتجسيدها بشكل إحترافي هو
                    عنصرٌ أهم لتبدأ به نحن في مجموعة خلود, نساعدك في بناء<br />
                    علامتك التجارية لنميزك عن منافسيك
                </p>
            </div>
            <div class="col-md-6 align-self-center">
                <img src="../img/design-section.svg" width="60%" alt="">
            </div>
            <div class="col-md-12">
                <br><br>
